...
<div class="print-container">
    <div class="doc-wrapper">
        <img src="{{ asset('images/coc_tc.png') }}" class="doc-img-coc" alt="COC">
        <div class="data-text" style="top: 102px; left: 628px; font-size: 22px; color: red">{{ $issuance->coc->coc_no }}</div>
        <div class="data-text" style="top: 155px; left: 695px;">{{ $issuance->policy_no }}</div>
        <div class="data-text" style="top: 190px; left: 45px;">{{ $issuance->assured }}</div>
        <div class="data-text" style="top: 230px; left: 45px;">{{ $issuance->address }}</div>

        <div class="data-text" style="top: 223px; left: 515px;">
            {{ \Carbon\Carbon::parse($issuance->created_at)->format('M d, Y') }}
        </div>
        <div class="data-text" style="top: 280px; left: 515px;">
            {{ \Carbon\Carbon::parse($issuance->created_at)->format('M d, Y') }}
        </div>
        <div class="data-text" style="top: 280px; left: 676px;">
            {{ \Carbon\Carbon::parse($issuance->created_at)->addYear()->format('M d, Y') }}
        </div>

        <div class="data-text" style="top: 325px; left: 45px;">{{ $issuance->vehicle->year_model ?? '' }}</div>
        <div class="data-text" style="top: 325px; left: 170px;">{{ $issuance->vehicle->make ?? '' }}</div>
        <div class="data-text" style="top: 325px; left: 335px;">{{ $issuance->vehicle->denomination ?? '' }}</div>
        <div class="data-text" style="top: 325px; left: 495px;">{{ $issuance->vehicle->color ?? '' }}</div>
        <div class="data-text" style="top: 325px; left: 640px;">{{ preg_replace('/^(\d{6})0+(\d+)/', '$1-$2', $issuance->vehicle->file_no) }}</div>

        <div class="data-text" style="top: 358px; left: 45px;">{{ $issuance->vehicle->plate_no ?? '' }}</div>
        <div class="data-text" style="top: 358px; left: 170px;">{{ $issuance->vehicle->chassis_no ?? '' }}</div>
        <div class="data-text" style="top: 358px; left: 335px;">{{ $issuance->vehicle->engine_no ?? '' }}</div>

    </div>

    <div class="doc-wrapper">
        <img src="{{ asset('images/tc_policy.jpg') }}" class="doc-img-policy" alt="Policy">
        <div class="data-text" style="top: 187px; left: 695px;">{{ $issuance->policy_no }}</div>
        <div class="data-text" style="top: 220px; left: 75px;">{{ $issuance->assured }}</div>
        <div class="data-text" style="top: 250px; left: 75px;">{{ $issuance->address }}</div>

        <div class="data-text" style="top: 237px; left: 485px;">
            {{ \Carbon\Carbon::parse($issuance->created_at)->format('M d, Y') }}
        </div>
        <div class="data-text" style="top: 280px; left: 485px;">
            {{ \Carbon\Carbon::parse($issuance->created_at)->format('M d, Y') }}
        </div>
        <div class="data-text" style="top: 280px; left: 649px;">
            {{ \Carbon\Carbon::parse($issuance->created_at)->addYear()->format('M d, Y') }}
        </div>

        <div class="data-text" style="top: 317px; left: 75px;">{{ $issuance->vehicle->year_model ?? '' }}</div>
        <div class="data-text" style="top: 317px; left: 200px;">{{ $issuance->vehicle->make ?? '' }}</div>
        <div class="data-text" style="top: 317px; left: 340px;">{{ $issuance->vehicle->denomination ?? '' }}</div>
        <div class="data-text" style="top: 317px; left: 475px;">{{ $issuance->vehicle->color ?? '' }}</div>
        <div class="data-text" style="top: 317px; left: 615px;">{{ preg_replace('/^(\d{6})0+(\d+)/', '$1-$2', $issuance->vehicle->file_no) }}</div>

        <div class="data-text" style="top: 343px; left: 75px;">{{ $issuance->vehicle->plate_no ?? '' }}</div>
        <div class="data-text" style="top: 343px; left: 200px;">{{ $issuance->vehicle->chassis_no ?? '' }}</div>
        <div class="data-text" style="top: 343px; left: 340px;">{{ $issuance->vehicle->engine_no ?? '' }}</div>
    </div>
